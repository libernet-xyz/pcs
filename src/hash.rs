...
pub trait ScalarHash<F: PrimeField> {
    /// Hashes two input values.
    fn hash_two_scalars(input1: F, input2: F) -> H256;

    /// Hashes three input values.
    fn hash_three_scalars(input1: F, input2: F, input3: F) -> H256;
    ...
    fn hash_many_scalars<I: IntoIterator<Item = F>>(inputs: I) -> H256;
}
...
pub trait HashBackend<F: PrimeField>: ScalarHash<F> + HashH256 {
    ...
    fn challenge<I: IntoIterator<Item = H256>>(dst: F, transcript_hashes: I) -> Result<F>;
}
...
impl ScalarHash<Scalar> for Sha2Hash<Scalar> {
...
impl HashH256 for Sha2Hash<Scalar> {
    fn hash_two_words(input1: H256, input2: H256) -> Result<H256> {
        let mut hasher = sha2::Sha256::default();
...
impl HashBackend<Scalar> for Sha2Hash<Scalar> {
    fn challenge<I: IntoIterator<Item = H256>>(
        ...
        Ok(Scalar::from_u512_mod_n(U512::from_big_endian(&bytes)))
    }
}
...
mod tests {
    ...
    fn test_sha2_hash_two_scalars() {
        assert_eq!(
            Sha2Hash::<Scalar>::hash_two_scalars(from_const(12), from_const(34)),
            parse_hash("0xe7148fa58812b9dc9041188cf631e333ed79b8e203992fbfcf7beb201c7c13f7")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_two_scalars(from_const(12), from_const(56)),
            parse_hash("0x36f7f77cbfe046d965d34cc3bd42d86b2e0ac42fc902196cdd3ac8810f02e5f0")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_two_scalars(from_const(56), from_const(78)),
    ...
    fn test_sha2_hash_two_words() {
        assert_eq!(
            Sha2Hash::<Scalar>::hash_two_words(h256(12), h256(34)).unwrap(),
            parse_hash("0xe7148fa58812b9dc9041188cf631e333ed79b8e203992fbfcf7beb201c7c13f7")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_two_words(h256(12), h256(56)).unwrap(),
            parse_hash("0x36f7f77cbfe046d965d34cc3bd42d86b2e0ac42fc902196cdd3ac8810f02e5f0")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_two_words(h256(56), h256(78)).unwrap(),
            parse_hash("0x7a83016495e114903621dc328b4bcfbf65aee3df18968ba278f8fc96283a2d92")
        );
    }
    ...
    fn test_sha2_hash_three_scalars() {
        assert_eq!(
            Sha2Hash::<Scalar>::hash_three_scalars(from_const(12), from_const(34), from_const(56)),
            parse_hash("0xbd08c4c9e298576ab0486eec6348a32b299de885ae958e995a4b517f2697b842")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_three_scalars(from_const(12), from_const(56), from_const(34)),
            parse_hash("0xba4e56fdf167d335b75d22469b2e24407a8efbdb4c8112546aa1519d9175b7f9")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_three_scalars(from_const(56), from_const(78), from_const(90)),
    ...
    fn test_sha2_hash_three_words() {
        assert_eq!(
            Sha2Hash::<Scalar>::hash_three_words(h256(12), h256(34), h256(56)).unwrap(),
            parse_hash("0xbd08c4c9e298576ab0486eec6348a32b299de885ae958e995a4b517f2697b842")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_three_words(h256(12), h256(56), h256(34)).unwrap(),
            parse_hash("0xba4e56fdf167d335b75d22469b2e24407a8efbdb4c8112546aa1519d9175b7f9")
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_three_words(h256(56), h256(78), h256(90)).unwrap(),
            parse_hash("0x83b5d2c73f322fe3c806514e7cbb7009796e4b9ed15b4766ac6dc04a24533647")
        );
    }
    ...
    fn test_sha2_hash_many_scalars() {
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_scalars([from_const(12)]),
            parse_hash("0xa82872b96246dac512ddf0515f5da862a92ecebebcb92537b6e3e73199694c45"),
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_scalars([from_const(12), from_const(34)]),
            parse_hash("0xe7148fa58812b9dc9041188cf631e333ed79b8e203992fbfcf7beb201c7c13f7"),
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_scalars([from_const(12), from_const(34), from_const(56)]),
            parse_hash("0xbd08c4c9e298576ab0486eec6348a32b299de885ae958e995a4b517f2697b842"),
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_scalars([
                from_const(56),
                from_const(78),
                from_const(90),
                from_const(12),
    ...
    fn test_sha2_hash_many_words() {
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_words([h256(12)]).unwrap(),
            parse_hash("0xa82872b96246dac512ddf0515f5da862a92ecebebcb92537b6e3e73199694c45"),
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_words([h256(12), h256(34)]).unwrap(),
            parse_hash("0xe7148fa58812b9dc9041188cf631e333ed79b8e203992fbfcf7beb201c7c13f7"),
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_words([h256(12), h256(34), h256(56)]).unwrap(),
            parse_hash("0xbd08c4c9e298576ab0486eec6348a32b299de885ae958e995a4b517f2697b842"),
        );
        assert_eq!(
            Sha2Hash::<Scalar>::hash_many_words([h256(56), h256(78), h256(90), h256(12), h256(34)])
                .unwrap(),
            parse_hash("0x4e8b5c5fe411c82f0449cead9ef8ae232d5dbb6bf91fefa0686f18062cc8f50e"),
        );
    }
    ...
    fn test_poseidon1_hash_two_scalars() {
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_two_scalars(from_const(12), from_const(34)),
            parse_hash("0x45470d74563e5e49fe3bd2a161b36116e3c6a6a2f9c105bfe8c2599ff6116b06")
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_two_scalars(from_const(12), from_const(56)),
            parse_hash("0x517c153fb7badd9aa6ac42a9528e58b48fb550f0d57d5aecdb2c09d355deb80d")
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_two_scalars(from_const(56), from_const(78)),
    ...
    fn test_poseidon1_hash_two_words() {
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_two_words(h256(12), h256(34)).unwrap(),
            parse_hash("0x45470d74563e5e49fe3bd2a161b36116e3c6a6a2f9c105bfe8c2599ff6116b06")
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_two_words(h256(12), h256(56)).unwrap(),
            parse_hash("0x517c153fb7badd9aa6ac42a9528e58b48fb550f0d57d5aecdb2c09d355deb80d")
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_two_words(h256(56), h256(78)).unwrap(),
            parse_hash("0x1ba4c686a3529d3bfc13890b2e1438b7adf780e2978cb2cabdd47653f402e8fe")
        );
    }
    ...
    fn test_poseidon1_hash_three_scalars() {
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_three_scalars(
                from_const(12),
                from_const(34),
                from_const(56)
            ),
    ...
    fn test_poseidon1_hash_three_words() {
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_three_words(h256(12), h256(34), h256(56)).unwrap(),
            parse_hash("0x1125d1d7bcc64d065695f306f08db087abc90d214fd982461296e607de7d4d49")
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_three_words(h256(12), h256(56), h256(34)).unwrap(),
            parse_hash("0x71c3d9b1e8a0e5102b7c56a20d1bc7a838f90881529e4132798df25f18980546")
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_three_words(h256(56), h256(78), h256(90)).unwrap(),
            parse_hash("0x516b43041b6e111a7be5670972354589d8686593fbd2a994e14c53e55bb803cd")
        );
    }
    ...
    fn test_poseidon1_hash_many_scalars() {
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_scalars([from_const(12)]),
            parse_hash("0x7c8412cec3a535ff1ceb3ed699e7a26f4bfdb11008ab52acdda94d8908e94232"),
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_scalars([from_const(12), from_const(34)]),
            parse_hash("0x6fda95845c8b151a4ec3317c5023a03da1e4d8404d1d8442897978cf7597cedb"),
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_scalars([
                from_const(12),
                from_const(34),
                from_const(56)
            ]),
    ...
    fn test_poseidon1_hash_many_words() {
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_words([h256(12)]).unwrap(),
            parse_hash("0x7c8412cec3a535ff1ceb3ed699e7a26f4bfdb11008ab52acdda94d8908e94232"),
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_words([h256(12), h256(34)]).unwrap(),
            parse_hash("0x6fda95845c8b151a4ec3317c5023a03da1e4d8404d1d8442897978cf7597cedb"),
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_words([h256(12), h256(34), h256(56)]).unwrap(),
            parse_hash("0x1125d1d7bcc64d065695f306f08db087abc90d214fd982461296e607de7d4d49"),
        );
        assert_eq!(
            Poseidon1Hash::<Scalar>::hash_many_words([
                h256(56),
                h256(78),
                h256(90),
                h256(12),
    ...
    fn test_poseidon2_hash_two_scalars() {
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_two_scalars(from_const(12), from_const(34)),
            parse_hash("0x165e74be18ef4be6de5e232cd3480dcc38176807ac918b904576964612c5b6de")
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_two_scalars(from_const(12), from_const(56)),
            parse_hash("0x5ad01fd39362490ad40fa8a2692c0f90ffed1c29bdc394366d9b54489d9df2d3")
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_two_scalars(from_const(56), from_const(78)),
    ...
    fn test_poseidon2_hash_two_words() {
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_two_words(h256(12), h256(34)).unwrap(),
            parse_hash("0x165e74be18ef4be6de5e232cd3480dcc38176807ac918b904576964612c5b6de")
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_two_words(h256(12), h256(56)).unwrap(),
            parse_hash("0x5ad01fd39362490ad40fa8a2692c0f90ffed1c29bdc394366d9b54489d9df2d3")
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_two_words(h256(56), h256(78)).unwrap(),
            parse_hash("0x38e7bb7b6ccae0c74031423877db058f4ab3a284964e2d91bf97497851eca5db")
        );
    }
    ...
    fn test_poseidon2_hash_three_scalars() {
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_three_scalars(
                from_const(12),
                from_const(34),
                from_const(56)
            ),
    ...
    fn test_poseidon2_hash_three_words() {
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_three_words(h256(12), h256(34), h256(56)).unwrap(),
            parse_hash("0x236092ebefc7e6565e0e75414d8fdce1ce2e19bb59002d36b794b9c3111bb9cd")
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_three_words(h256(12), h256(56), h256(34)).unwrap(),
            parse_hash("0x0ae96711384158467002a664233e687ce6f3c0f27ac41ea97ac378c72ad4077e")
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_three_words(h256(56), h256(78), h256(90)).unwrap(),
            parse_hash("0x2fa39a3a76d0cf8220bd6f9899b209110ad1cca7b0bdc2b340661fa7063f2ba0")
        );
    }
    ...
    fn test_poseidon2_hash_many_scalars() {
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_scalars([from_const(12)]),
            parse_hash("0x45782306ba3302ebe2f07eacbf5d0c36a5f307dc1cde4f3f9e8196ef498eddf2"),
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_scalars([from_const(12), from_const(34)]),
            parse_hash("0x08802dc1d5eaf75680808adb1d19bb420f34f5e786f09e05ffa5d41fb2bdfe6d"),
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_scalars([
                from_const(12),
                from_const(34),
                from_const(56)
            ]),
    ...
    fn test_poseidon2_hash_many_words() {
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_words([h256(12)]).unwrap(),
            parse_hash("0x45782306ba3302ebe2f07eacbf5d0c36a5f307dc1cde4f3f9e8196ef498eddf2"),
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_words([h256(12), h256(34)]).unwrap(),
            parse_hash("0x08802dc1d5eaf75680808adb1d19bb420f34f5e786f09e05ffa5d41fb2bdfe6d"),
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_words([h256(12), h256(34), h256(56)]).unwrap(),
            parse_hash("0x236092ebefc7e6565e0e75414d8fdce1ce2e19bb59002d36b794b9c3111bb9cd"),
        );
        assert_eq!(
            Poseidon2Hash::<Scalar>::hash_many_words([
                h256(56),
                h256(78),
                h256(90),
                h256(12),
