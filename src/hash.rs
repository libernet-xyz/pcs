...
mod tests {
    ...
    fn test_sha2_hash_raw() {
        assert_eq!(
            Sha2Hash::hash_raw(12.into(), 34.into(), 56.into()),
            parse_scalar("0x6ba46ed6f29f6a4f8e1a9d8f93b51f5e902143d00356b65b867dde9cc879a8d1")
        );
        assert_eq!(
            Sha2Hash::hash_raw(56.into(), 78.into(), 90.into()),
    ...
    fn test_sha2_hash_three() {
        assert_eq!(
            Sha2Hash::hash_many(&[12.into(), 34.into(), 56.into()]),
            parse_scalar("0x6ba46ed6f29f6a4f8e1a9d8f93b51f5e902143d00356b65b867dde9cc879a8d1")
        );
        assert_eq!(
            Sha2Hash::hash_many(&[56.into(), 78.into(), 90.into()]),
            parse_scalar("0x1d6f14df7d976189975985d9427a9afc683c573adff33c4e77f0f0a577ac6062")
        );
    }
    ...
    fn test_poseidon2_hash_raw() {
        assert_eq!(
            Poseidon2Hash::hash_raw(12.into(), 34.into(), 56.into()),
            parse_scalar("0x236092ebefc7e6565e0e75414d8fdce1ce2e19bb59002d36b794b9c3111bb9cd")
        );
        assert_eq!(
            Poseidon2Hash::hash_raw(56.into(), 78.into(), 90.into()),
    ...
    fn test_poseidon2_hash_three() {
        assert_eq!(
            Poseidon2Hash::hash_many(&[12.into(), 34.into(), 56.into()]),
            parse_scalar("0x236092ebefc7e6565e0e75414d8fdce1ce2e19bb59002d36b794b9c3111bb9cd")
        );
        assert_eq!(
            Poseidon2Hash::hash_many(&[56.into(), 78.into(), 90.into()]),
            parse_scalar("0x2fa39a3a76d0cf8220bd6f9899b209110ad1cca7b0bdc2b340661fa7063f2ba0")
        );
    }
